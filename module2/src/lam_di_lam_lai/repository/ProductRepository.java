...
import lam_di_lam_lai.common.ReadAndWrite;
...
public class ProductRepository implements IProductRepository {
    ...
    private static final String PATH_PRODUCT = "src/lam_di_lam_lai/file.csv";
    ...
    public void delete(Product product) {
        ...
        List<String> strings = new ArrayList<>();
        for (Product p : products) {
            strings.add(p.getCodeProduct() + "," + p.getNameProduct() + "," + p.getQuantity() +
